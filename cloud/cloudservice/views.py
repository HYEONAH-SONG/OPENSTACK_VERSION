...
def send(request):
    ...
    auth_res = requests.post("http://192.168.56.108/identity/v3/auth/tokens",
    ...
    index_res = requests.get("http://192.168.56.108:8080/v1/AUTH_61ac152501f64d30b8c4f9fb420e50e3/files/index.json",
